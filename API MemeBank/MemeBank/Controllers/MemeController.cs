...
namespace MemeBank.Controllers
{
    ...
    public class MemeController : ControllerBase
    {
        ...
        // GET: api/Meme/Tags 
        // allows the user to search by Tags, creates new api endpoint to search by tag then returns the list
        [Route("tags")]
        [HttpGet]
        ...
        /*
            1. Takes Request, checks if its correct type.
            2. Reads the image
            3. Uploads image to the blob storage container (memebank1001)
            4. if successful, add entry into our Sqlite database
                (title, tag, image url, upload date, image size)
            5. Save entry into database
        ...
        public async Task<IActionResult> UploadFile([FromForm]MemeImageItem meme)
        {
            ...
            try
            {
                ...
                {
                    //3. Upload image to blob storage container
                    ...
                    //4. Entry info for our Sqlite database
