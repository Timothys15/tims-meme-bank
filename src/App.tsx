...
class App extends React.Component<{}, IState> {
	...
	private fetchMemes(tag: any) {
		let url = "http://timsmemebank1001.azurewebsites.net/api/meme"

		// any tags specified in parameter, appends to the url
		if (tag !== "") {
			url += "/tag?=" + tag
		}
		fetch(url, {
	...
	private uploadMeme() {
		...
		const url = "http://timsmemebank1001.azurewebsites.net/api/meme/upload"
